...
class OSS:
    ...
    def Connecting_minio(self):
        ...
        client = Minio(
            self.host, access_key=ACCESS_KEY, secret_key=SECRET_KEY, secure=False
        )
        return client
    ...
    def fget_object(self, object_name, file_path):
        self.client.fget_object(
            self.buckets_name, object_name, os.path.join(file_path, object_name)
        )
    ...
    def get_object_name_2(self, buckets_name):  # 获取桶对象名称
