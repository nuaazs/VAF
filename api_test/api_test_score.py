...
if args.mode == 'file':
    ...
    values = {"spkid1": str(phone1),"spkid2": str(phone2),"show_phone": "15151832002","call_begintime":begintime,"call_endtime":endtime}
    print(values)
    # !不能指定header
    ...
    phone1 = random.randint(11111111111, 99999999999)
    phone2 = random.randint(11111111111, 99999999999)
    values = {"spkid1": str(phone1),"spkid2": str(phone2),"show_phone": "15151832002","wav_url1":wav_url1,"wav_url2":wav_url2}
    print(values)
